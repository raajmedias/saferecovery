                ...
                <div className="main-bar clearfix ">
                    <div className="container clearfix">
                        ...
                        <div className="logo-header mostion logo-dark w-25">
                           ...
                           <Link href="/"><a className="text-uppercase h3">Safe Recovery</a></Link>
                        </div>
                        {/* <!-- Nav Toggle Button --> */}
                        ...
                        <div className="extra-nav">
                            <div className="extra-cell">
                                <Link href="/contact"><a className="btn btn-link d-inline-flex align-items-center"><i className="fa fa-angle-right m-r10"></i>Get A Quote</a></Link>
                            </div>
                        </div>
